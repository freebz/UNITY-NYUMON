...
function Update () {
    ...
    if (controller.isGrounded) {
        ...
        //var joystick : Joystick = FindObjectOfType(Joystick) as Joystick;
        //velocity = Vector3(joystick.position.x, 0, joystick.position.y);
        velocity = Vector3(CrossPlatformInputManager.GetAxis("Horizontal"), 0, CrossPlatformInputManager.GetAxis("Vertical"));
        velocity *= walkSpeed;
